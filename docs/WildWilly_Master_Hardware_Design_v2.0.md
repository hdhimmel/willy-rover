...
| Screw-terminal GPIO breakout HAT | 40-pin breakout, **13 lines** — 14 with the optional ToF UART return. Count from §5.3's table, not from prose. Replaces the removed Seengreat | 1 | **On order 2026-09-09** |
