...
- **DONE:** 5 (§8 odometry, §9 world model milestone 1, §10 mapping/learning mode milestone 1, §16 retrieval modulo hardware-calibration gaps, §19 hardware abstraction for motors/sensors/arm — camera/display out of scope)
- **PARTIAL:** 8 (§4, §6, §12, §13, §18, §20, §21, §22)
- **MISSING:** 2 (§11, §17-expected)
